    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><i class="el-icon-lx-calendar"></i> 故事</el-breadcrumb-item>
                <el-breadcrumb-item>故事信息</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
                ...
                <div class="container">
                    <div class="form-box">
                        <el-form  label-width="100px" :model="form" :rules="rules" ref="form">
                            <el-col :span="12">
                                <el-form-item label="故事编号">
                                    <el-input v-model="form.news_id"></el-input>
                                </el-form-item>
                            </el-col>
                            <el-col :span="12">
                                <el-form-item label="故事状态">
                            ...
                            <el-form-item label="故事类型" prop="news_type">
                                <el-select class="handle-select mr10" v-model="form.news_type" placeholder="请输入故事类型">
                                    ...
                                    <el-option key="2" label="故事资讯" value="故事资讯"></el-option>
                                </el-select>
                            </el-form-item>
                            ...
                            <el-form-item label="故事图片"  prop="news_picpath">
                                <div class="crop-demo" >
                                    <img :src="cropImg" class="pre-img" prop="cropImg">
    ...
    export default {
        ...
        methods: {
            onSubmit() {
                this.$refs.form.validate((valid) => {
                    if (valid) {
                        ...
                        this.$http.post('/neusoft/user/updateNews', params).then(response => {
            ...
            init(){
                ...
                this.$http.post('/neusoft/user/getNewsById', params).then(response => {
                    var resBody = response.body
                    console.log(resBody)
                    if (resBody.isSuccess === 0) {
                        this.form = resBody.result.news
                        this.defaultSrc = this.form.news_picpath
                        this.cropImg = this.defaultSrc
                        if(this.form.news_state === 1){
                            this.status = "待审核"
                        }else if(this.form.news_state === 2){
                            this.status= "审核成功"
                        }else{
                            this.status= "审核失败"
                        }
