                        ...
                        <el-form  label-width="100px"  :model="form" :rules="rules" ref="form">
                            <el-col :span="12">
                                <el-form-item label="房屋编号">
                                    <el-input v-model="form.house_id"></el-input>
                                </el-form-item>
                            </el-col>
                            <el-col :span="12">
                            ...
                            <el-form-item label="户型" prop="house_type">
                                <el-input v-model="form.house_type" style="width:40%;"></el-input>
                            </el-form-item>
                            <el-form-item label="房屋用途" prop="house_purpose">
                                <el-input v-model="form.house_purpose"></el-input>
                            </el-form-item>
                            <el-form-item label="房屋初价" prop="house_initalprice">
                                <el-input v-model="form.house_initalprice"></el-input>
                                元/m²
                            </el-form-item>
                            <el-form-item label="房屋面积" prop="house_area">
                                <el-input v-model="form.house_area"></el-input>
                                m²
                            </el-form-item>
                            <el-form-item label="阳台面积" prop="balcony_area">
                                <el-input v-model="form.balcony_area"></el-input>
                                m²
                            </el-form-item>
                            <el-form-item label="所属楼层" prop="house_floor">
                                <el-input v-model="form.house_floor"></el-input>层
                            </el-form-item>
                            <el-form-item label="房高" prop="house_height">
                                <el-input v-model="form.house_height"></el-input>
                                m
                            </el-form-item>
                            <el-form-item label="装修状况" prop="decoration_condition">
                                <el-input v-model="form.decoration_condition"></el-input>
                            </el-form-item>
                            <el-form-item label="建成日期"  prop="finish_date">
                            ...
                            <el-form-item label="房屋朝向" prop="house_toward">
                                <el-input v-model="form.house_toward"></el-input>
                            </el-form-item>
                            <el-form-item label="房屋特色" prop="building_structure">
                                <el-input v-model="form.building_structure"></el-input>
                            </el-form-item>
                            <el-form-item label="公用分摊建筑面积" prop="public_area">
                                <el-input v-model="form.public_area"></el-input>m²
                            </el-form-item>
                            <el-form-item label="备注" prop="house_remark">
                                <el-input v-model="form.house_remark"></el-input>
                            </el-form-item>
    ...
    export default {
        ...
        methods: {
            onSubmit() {
                this.$refs.form.validate((valid) => {
                    if (valid) {
                        ...
                        this.$http.post('/neusoft/user/house/updateHouse', params).then(response => {
            ...
            init(){
                ...
                this.$http.post('/neusoft/user/house/getHouseById', params).then(response => {
                    var resBody = response.body
                    if (resBody.isSuccess === 0) {
                        this.form = resBody.result.house
                        this.defaultSrc = this.form.house_pic
                        this.cropImg = this.defaultSrc
                        this.defaultSrc1 = this.form.rendings_pic
                        this.cropImg1 = this.defaultSrc1
                        if(this.form.house_state === 1){
                            this.status = "待审核"
                        }else if(this.form.house_state === 2){
                            this.status= "审核成功"
                        }else{
                            this.status= "审核失败"
                        }
